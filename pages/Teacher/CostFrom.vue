                                    ...
                                    <b-row>
                                        <b-col cols="12" sm="6">
                                            <b-input-group prepend="Name" class="mt-3">
                                                <b-input v-model="TName" disabled>
                                                </b-input>
                                            </b-input-group>
                                        </b-col>
                                        ...
                                        <b-col cols="12" sm="6">
                                            <b-input-group prepend="ID" class="mt-3">
                                                <b-input v-model="TId" disabled>
                                                </b-input>
                                            </b-input-group>
                                        </b-col>
                                        <b-col cols="12" sm="6">
                                            <b-input-group prepend="Tel." class="mt-3">
                                                <b-input v-model="TTelephoneNum" disabled>
                                                </b-input>
                                            </b-input-group>
                                        </b-col>
                                    </b-row>
                ...
                <v-col cols="12" sm="8" md="6">
                    <v-card class="elevation-12">
                        ...
                        <v-card-text>
                            <v-row>
                                <v-col cols="12" sm="6">
                                    <v-text-field label="First name" ref="Fname" v-model="editedItem.Fname" outlined dense required>
                                    </v-text-field>
                                </v-col>

                                <v-col cols="12" sm="6">
                                    <v-text-field label="Last name" ref="Lname" v-model="editedItem.Lname" outlined dense required>
                                    </v-text-field>
                                </v-col>

                                <v-col cols="12" sm="6">
                                    <v-text-field label="Student ID" ref="SID" v-model="editedItem.SID" outlined dense required>
                                    </v-text-field>
                                </v-col>

                                <v-col cols="12" sm="6">
                                    <v-text-field label="Mobile Phone" ref="Phone" v-model="editedItem.Phone" outlined dense required>
                                    </v-text-field>
                                </v-col>
                            </v-row>
                            ...
                            <v-row>
                                <v-col cols="12" sm="6">
                                    <v-select :items="School" label="School" v-model="editedItem.selectedSchool" @input="schoolSelect" dense outlined required>
                                    </v-select>
                                </v-col>

                                <v-col cols="12" sm="6">
                                    <v-select :items="Major" label="Major" v-model="editedItem.selectedMajor" dense outlined required>
                                    </v-select>
                                </v-col>
